 ...
 *
 * (Identical to templates/market-maker/lib/mcp-client.ts — the two starters
 * share the same transport. If you fork both, factor this into one package.)
 */
...
export async function startSeraMcp(opts: SeraMcpClientOptions): Promise<SeraMcpClient> {
  ...
  await rpc("initialize", {
    ...
    capabilities: {},
    clientInfo: { name: "sera-taker", version: "0.1.0" },
  });
